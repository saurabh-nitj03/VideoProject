...
const loginUser = asyncHandler(async(req,res)=>{
    ...
    const {username,email,password}=req.body;
     ...
     if(!user) {
        throw new ApiError(400, "User with this username or email is not present !pls register first");
     }
...
const updateAccountDetails=asyncHandler(async(req,res)=>{
    ...
    if(!fullname || !email) throw new ApiError(400, "fullname and email is required")
    ...
    return res.status(200).json(new ApiResponse(200,user,"All details updated successfully "))
...
const updateUserAvatar=asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,user,"avatar image is updated"))
})
...
const updateUserCoverImage=asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,{},"avatar image is updated"))
})
